...
private:
	/*
		...
		mCollisionConfig: utilizada para configurar el btCollisionDispacher. 
				Proporciona información sobre agrupaciones de almacenamiento intermedios utilizados durante las colisiones.

		mBroadphase: se encarga de la primera fase de detección de colisiones, es decir, quien y con quien se choca.
					Seran incluidos en el btDispatcher que decidirá quien colisiona o no.
	*/
